...
const contactInfo = ref([
    ...
    },
    {
        ...
        content: {
            type: 'a',
            props: { href: 'mailto:info@gmail.com' },
            text: 'info@gmail.com',
        }
    },
    {
        ...
        content: {
            type: 'span',
            props: {},
            text: 'Sun–Tue: 9AM–8PM, Fri: 2PM–9PM',
        }
    },
]);
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                ...
                <section class="lg:col-span-2">
                    <header class="flex items-center mb-6">
                        <Icon icon="fa-solid:clinic-medical" class="text-3xl text-pink-500 mr-3" />
                ...
                <section>
                    <h3 class="text-xl font-bold mb-6 relative pb-2
                        ...
                        after:w-12 after:h-1 after:bg-pink-500">
                        Quick Links
                    </h3>
                    ...
                    <nav aria-label="Quick links">
                        <ul class="space-y-3">
                            <li v-for="(item, index) in quickLinks" :key="index">
                                <a :href="item.href" class="text-gray-400 hover:text-pink-500 transition">
                                    {{ item.text }}
                                </a>
                            </li>
                        </ul>
                ...
                <address>
                    ...
                    <ul class="space-y-4">
                        <li v-for="(item, index) in contactInfo" :key="index" class="flex items-start">
                            <Icon :icon="item.icon" class="text-pink-500 text-xl mt-1 mr-4 flex-shrink-0" />
            ...
            <section class="bg-gray-800 rounded-xl p-8 mb-12">
                <div class="flex flex-col lg:flex-row items-center justify-between">
                    ...
                    <form class="flex flex-col sm:flex-row w-full lg:w-auto">
                        <input type="email" id="newsletter-email" placeholder="Your email address" class="px-6 py-3 rounded-full bg-gray-700 text-white
                                      focus:outline-none focus:ring-2 focus:ring-pink-500
                                      mb-3 sm:mb-0 sm:mr-4 w-full" />

                        <button class="bg-pink-600 hover:bg-pink-700 text-white px-8 py-3 rounded-full
                                   transition shadow-lg w-full md:w-auto whitespace-nowrap">
                            Subscribe
                        </button>
                    </form>
                </div>
            ...
            <footer class="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
                <p class="text-gray-500 text-sm mb-4 md:mb-0">
                    &copy;{{ currentYear }} Glamour Clinic. All rights reserved</p>
                <nav aria-label="Legal links">
                    <ul class="flex space-x-6">
                        <li v-for="(link, index) in legalLinks" :key="index">
                            <a :href="link.href" class="text-gray-500 hover:text-pink-500 text-sm transition">{{
                                link.text }}</a>
                        </li>
                    </ul>
                </nav>
